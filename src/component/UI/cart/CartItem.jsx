...
const CartItem = ({item}) => {
    ...
    const incrementItem = () => dispatch(cartActions.addItem({...item}));
    const decreasetItem = () => dispatch(cartActions.removeItem(id));
    const deleteItem = () => {
            ...
            <div className="cart__item-info d-flex gap-2">
                ...
                <div className="cart__product-info d-flex align-items-center gap-4 justify-content-between w-100">
                    <div>
                        ...
                        cart__product-price'>{quantity}x <span>${totalPrice}</span></p>
